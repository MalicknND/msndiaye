...
const Approach = () => {
  return (
    <section id="testimonials" className="w-full py-20 bg-black-100 pt-24">
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center max-w-sm w-full mx-auto p-4 relative lg:h-[35rem] rounded-3xl bg-black-100"
      style={{
    ...
    >
      ...
      <div className="relative z-20 px-10">
        ...
        <p className="text-sm opacity-0 group-hover/canvas-card:opacity-100 relative z-10 mt-4 group-hover/canvas-card:text-white/80 text-center group-hover/canvas-card:-translate-y-2 transition duration-200 text-white/80">
          {des}
        </p>
      </div>
    </div>
